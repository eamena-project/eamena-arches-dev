...
See [append_filter_data()](https://github.com/eamena-project/eamena-functions/blob/ed4b489277b1d4045650c9cb0920ec99c7f5bd57/business_data.py#L5) in the [eamena-functions](https://github.com/eamena-project/eamena-functions/) repo.

```mermaid
flowchart
  id3[BU append template] --- r2r;
  id3 --- id4[QGIS];
  subgraph local
    direction TB
