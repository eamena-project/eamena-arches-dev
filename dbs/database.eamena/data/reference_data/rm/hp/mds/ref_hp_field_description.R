...
#' ref_hp_field_description(mds.template = "C:/Rprojects/eamena-arches-dev/dbs/database.eamena/data/reference_data/rm/hp/mds/mds-template.xlsx", mds.datatable.name = "fields-description.html")
#'
#' # Create and plot the datatable
#' ref_hp_field_description(mds.template = "C:/Rprojects/eamena-arches-dev/dbs/database.eamena/data/reference_data/rm/hp/mds/mds-template.xlsx", create.datatable = FALSE)
#' 
#' @export
ref_hp_field_description <- function(mds.template = "https://raw.githubusercontent.com/eamena-project/eamena-arches-dev/main/dbs/database.eamena/data/reference_data/rm/hp/mds/mds-template.xlsx",
