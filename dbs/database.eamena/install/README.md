...
flowchart
	...
	id5-->id6[IMPORT]
	id7[Install empty Arches v7]-->id25[<a href="hhttps://github.com/eamena-project/eamena-arches-dev/tree/main/dbs/database.eamena/install#install-eamena-customisations">Install EAMENA customisations</a>]
