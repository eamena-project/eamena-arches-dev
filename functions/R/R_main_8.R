...
source(paste0(dir_funct, "R_functions_8_to_eamena-r.R"))  # read the functions file
...
if(basic.statistics){
  ...
  d_sql <- basic_stats("eamena", d_sql)
  d_sql <- basic_stats("eamena", d_sql, field = "duplicated_hp", stat.choice = "duplicates")
  d_sql$count_hp
  d_sql$duplicated_hp
}
