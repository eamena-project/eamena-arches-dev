...
```sh
(ENV) root@ip-172-31-39-197:/opt/arches/eamena# python manage.py packages -o import_business_data -s ../data_temp/business_data/bu_ir_cod.csv -c ../data_temp/business_data/Information_Resource.mapping -ow overwrite
```
```
operation: import_business_data
Importing /opt/arches/eamena/../data_temp/business_data/bu_ir_cod.csv. . .
Starting import of business data
********************************************************************************
2024-09-12 10:45:10,235 arches.app.utils.data_management.resources.formats.csvfile ERROR    No column 'ResourceID' found in business data file.                         Please add a 'ResourceID' column with a unique resource identifier.
********************************************************************************
2024-09-12 10:45:10,238 arches.app.utils.data_management.resources.formats.csvfile ERROR    Traceback (most recent call last):

2024-09-12 10:45:10,238 arches.app.utils.data_management.resources.formats.csvfile ERROR      File "/opt/arches/ENV/lib/python3.8/site-packages/arches/app/utils/data_management/resources/formats/csvfile.py", line 571, in import_business_data
