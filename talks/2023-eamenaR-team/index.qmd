...
Allow the package to work with different instances of <img src='https://raw.githubusercontent.com/eamena-project/eamena-arches-dev/master/www/app-arches.png' style='height: 40px;vertical-align: middle;'>
...
The function [ref_ids()](https://eamena-project.github.io/eamenaR/doc/ref_ids) retrieve the correspondences between a customized label and its counterparts in the <img src='https://raw.githubusercontent.com/eamena-project/eamena-arches-dev/master/www/app-arches.png' style='height: 40px;vertical-align: middle;'> instance. For example, working with the EAMENA IDs
...
# Analyse<br>and audit {background-color="#f3e7b3"}

## Generalities

Several types of plots and maps can be created 'flat' or interactive by setting the option `interactive` to `r TRUE`
