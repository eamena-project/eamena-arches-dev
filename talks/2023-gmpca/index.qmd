...
# EAMENA project {background-image="https://raw.githubusercontent.com/eamena-project/eamena-arches-dev/master/www/23889489303_b3df7d8cef_o.jpg"}
...
<skos:narrower>
  <skos:Concept rdf:about="http://localhost:8000/dd33ef4a-0f20-4b9a-9a73-f2ed5bbd11ff">
    ...
    <skos:narrower rdf:resource="http://localhost:8000/d2fb3e32-43ae-428b-9e48-9c0e1ad3ce3f"/>
    <arches:collector xml:lang="en-us">{"id": "805b6e2c-4ad5-4326-add3-aff8284ccb03", "value": "41"}</arches:collector>
    <skos:inScheme rdf:resource="http://localhost:8000/4a98075d-815f-327b-be0e-518b32f7623b"/>
    <arches:sortorder xml:lang="en-us">{"id": "0017a1a5-0b05-4b69-b632-caa263e42ec5", "value": "41"}</arches:sortorder>
    <skos:narrower rdf:resource="http://localhost:8000/8ec95fc4-4c38-4e43-a409-72584bb3c63f"/>
  </skos:Concept>
</skos:narrower>
```

[🔗](https://github.com/achp-project/prj-eamena-marea/blob/f76031efb09a5cc425d544ee26432bf2d9d4b308/reference_data/concepts/EAMENA.xml#L7841-L7854)
...
<div class="captiontext">EDTF data collected over a period of fifteen years (2004-2019), 63 events, on 19 archaeological sites in NW Syria</div>
...
cf. <small>https://eamena-project.github.io/reveal.js/projects/time#/9></small>
...
<img src='https://raw.githubusercontent.com/eamena-project/eamena-arches-dev/master/www/wgs84-qasr-al-hallabat.png.png' style='height: 300px;'>

</center>

<div class="captiontext">Report (detail) of Qasr al-Hallabat Umayyad castle (Zarqa, Jordan)</div>


### IIIF

<img src='https://raw.githubusercontent.com/eamena-project/eamena-arches-dev/master/www/app-arches.png' style='height: 35px;vertical-align: middle;'> integrates the International Image Interoperability Framework ([IIIF](https://iiif.io/))[^5]
...
<div class="captiontext">Qasr al-Hallabat Umayyad castle (Zarqa, Jordan)</div>
...
<img src="https://raw.githubusercontent.com/eamena-project/eamenaR/main/results/caravanserail_paths.png" width="500">
...
<img src="https://raw.githubusercontent.com/eamena-project/eamenaR/main/results/map_path_profile.png" width="500">
...
```{=html}
<embed src="https://www.getty.edu/publications/cultural-heritage-mass-atrocities/" width="700px" height="500px" />
```
