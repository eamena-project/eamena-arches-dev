...
```{=html}
<div style="display: flex; justify-content: center;">
<embed src="https://achp-project.github.io/cultural-heritage/map-projects/arches-global-south.html" />
</div>
```
...
::: {.column width="30%"}
<div class="captiontext">
in <span style="color:blue;">blue: </span>Heritage Places; in <span style="color:green;">green: </span> Information Resources; in <span style="color:grey;">grey (grid): </span>Grid Squares
</div>
:::
...
<img src="https://raw.githubusercontent.com/eamena-project/eamena-arches-dev/master/talks/2024-chma/img/dal01--relatedresources.png" height="350">
