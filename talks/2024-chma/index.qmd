...
- Rapidly record and assess the status of the archaeological landscape (built heritage)
- Provide access to the international community to a set of data on endangered heritage (Open Access)
...
<img src="https://raw.githubusercontent.com/eamena-project/eamena-arches-dev/master/www/arches-v7-grids-ea-ge.png" height="400">
...
<img src="https://raw.githubusercontent.com/eamena-project/eamena-arches-dev/master/www/geoserver-map-wfs-gs-nb-hp-2024.png" height="400">

</center>
<div class="captiontext">EAMENA Heritage Places counts in 2023</div>
...
```{=html}
<iframe width="500" height="500" src="https://CAA-France.github.io/website/diagrams/oarch_repo_user.html"></iframe>
```

Source: <a href="https://github.com/zackbatist/openarchaeo-collaboration" data-type="link" data-id="openarchaeo-collaboration" target="_blank" rel="noreferrer noopener">openarchaeo-collaboration</a>, published by Batist, Z.; Roe, J., 2024. Open archaeology, open source? ... <em>Internet Archaeology</em> 67. <a href="https://doi.org/10.11141/ia.67.13" data-type="link" data-id="10.11141/ia.67.13" target="_blank" rel="noreferrer noopener">10.11141/ia.67.13</a>

### ACHP projects

```{=html}
<iframe width="500" height="500" src="https://achp-project.github.io/cultural-heritage/map-projects/arches-global-south.html"></iframe>
```
...
```{=html}
<iframe width="1000" height="400" src="https://eamena-project.github.io/eamena-arches-dev/dbs/database.eamena/data/reference_data/rm/hp/mds/fields-description.html"></iframe>
```
