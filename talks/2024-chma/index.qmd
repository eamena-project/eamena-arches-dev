...
::: {.column width="25%"}
<img src="https://raw.githubusercontent.com/eamena-project/eamena-arches-dev/master/talks/2024-chma/img/dal01-gs-map.png" height="300">
:::
...
```{mermaid}
flowchart LR
  id1[Heritage<br>Places] <---> id2[Information<br>Resource];
  id2 <---> id3[ResourceSpace<br>collection];
