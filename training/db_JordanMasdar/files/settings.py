"""
Django settings for jordan_project project.
"""
...
APP_NAME = 'jordan_project'
APP_ROOT = os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))
STATICFILES_DIRS =  (os.path.join(APP_ROOT, 'media'),) + STATICFILES_DIRS

DATATYPE_LOCATIONS.append('jordan_project.datatypes')
FUNCTION_LOCATIONS.append('jordan_project.functions')
SEARCH_COMPONENT_LOCATIONS.append('jordan_project.search_components')
...
SECRET_KEY = 'gba+rts$7&iq10xv&z+*8&w_5($@8!px2e1ns*0#kczi8bem(g'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'jordan_project.urls'

# a prefix to append to all elasticsearch indexes, note: must be lower case
ELASTICSEARCH_PREFIX = 'jordan_project'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'jordan_project.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'jordan_project.wsgi.application'
...
SESSION_COOKIE_NAME = 'jordan_project'
