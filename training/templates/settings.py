...
DATATYPE_LOCATIONS.append('project.datatypes')
FUNCTION_LOCATIONS.append('project.functions')
SEARCH_COMPONENT_LOCATIONS.append('project.search_components')
...
SECRET_KEY = '3u5z0nfy0l9!&=z7ju^98p&*gw%bg4m8xn7wztc5kwh6grdsb0'
...
# [{
#     'module': 'project.search_indexes.sample_index.SampleIndex',
